...
preset_server() {
    ...
    ascli conf preset update era --url=ssh://fasp.sra.ebi.ac.uk:33001 --username=era-fasp --ssh-keys=$SSH_KEY --ts=@json:'{"target_rate_kbps":300000}'
}

preset_server

ascli -Pera server download vol1/fastq/ERR164/ERR164407/ERR164407.fastq.gz --to-folder=$SRA_CACHE